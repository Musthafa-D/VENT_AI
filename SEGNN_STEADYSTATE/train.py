...
import params
from utils import explain_node_prediction, explain_graph_prediction, grad_cam_plots, velocity_pressure, compute_shap_values, plot_shap, plot_ind_shap
...
def val(model, loader, loss_func, mask = False, calculate_gradcam=False, 
...
for epoch in range(args.epochs):
    ...
    val_loss = val(model, v_loader, loss_func, mask, 
                   calculate_gradcam=True, calculate_node_prediction=True, calculate_shap=False)
